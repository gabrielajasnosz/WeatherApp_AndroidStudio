...
public class display_weather extends AppCompatActivity {
...
//        System.out.println(iconUrl);
        ...
        time.setText(time3);
        //Picasso.with(this).load("http://openweathermap.org/img/wn/09d@2x.png").error(R.drawable.error).into(icon);
